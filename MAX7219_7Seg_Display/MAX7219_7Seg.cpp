...
// Constructor
//========================================================================
MAX7219_7Seg::MAX7219_7Seg(int DIN, int CS, int CLK)
{
...
// Public Methods
//========================================================================
void MAX7219_7Seg::Initialize(byte brightLevel)
{
...
//========================================================================
void MAX7219_7Seg::Number(byte digit, byte n)
{
  switch(digit)
  {
...
//========================================================================
void MAX7219_7Seg::Numberdp(byte digit, byte n)
{
  byte cb;
  switch(n)
  {
...
//========================================================================
void MAX7219_7Seg::Char(byte digit, char c)
{
  byte cb;
  switch(c)
  {
...
// Private Methods
//========================================================================
void MAX7219_7Seg::Write(byte cmd, byte data)
{
...
//========================================================================
void MAX7219_7Seg::SPI_send(byte data)
{
  for(byte i=0; i<8; i++)
  {
